...
int moveArrange = 500;
int stepperDelay = 800; // 300, 430
float stepperDelay_1, stepperDelay_2, stepperDelay_3, stepperDelay_4 = 800;
...
//        deterTrue_E1 = false;
      ...
      delayMicroseconds(stepperDelay_1*1000); //stepperDelay: 800
    }
    else
    {
//      Serial.print("Operation time: ");

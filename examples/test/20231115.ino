...
//        Serial.println(countSizeofList);
        receivedDistanceList_0 = A[0][countSizeofList];
        receivedDistanceList_1 = B[0][countSizeofList];
        targetEncoderList_0 = A[0][countSizeofList+1];
        
        cycletimeList_ = A[1][countSizeofList]/10;
        
        motor0.moveTo(receivedDistanceList_0);
        motor1.moveTo(receivedDistanceList_1);
        motor2.moveTo(receivedDistanceList_1);
        motor3.moveTo(receivedDistanceList_1);

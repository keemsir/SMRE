...
//    motor4.runEncoder();
    ...
    if (receivedDistance_0 == motor1.currentPosition() && receivedDistance_1 == motor2.currentPosition())
    ...
    else if (-receivedDistance_0 == motor1.currentPosition())
    {
      time_b = millis();
      Serial.print("Time:");
      Serial.println(time_b - time_a);
...
void printCurrent()
{
  ...
  Serial.print(motor4.currentPosition());
  Serial.print(", ");
  Serial.println(motor4.targetPosition());
  Serial.println("");
}
...
void samplePrint()
{
  ...
  Serial.print("Encoder4(current, target): ");
  Serial.print(motor4.currentPositionEncoder());
  Serial.print(", ");
  Serial.println(motor4.targetPositionEncoder());

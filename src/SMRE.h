...
public:
    ...
    /// to pin 5.
    SMRE(uint8_t pins = 4, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5);
    ...
    SMRE(void (*forward)(), void (*backward)());
...
protected:
    ...
    /// Compute and return the desired time.
    virtual float timeSpeed();
...
private:
    ...
    /// The target position in steps. The SMRE library will move the
